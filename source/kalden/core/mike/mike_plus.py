...
class MPlusModel:
    ...
    def insert_qml_style_into_gpkg(
        ...
        Args:
            ...
            qml_path: Path to the existing QML file.
            style_name: Saved style name. Defaults to layer_name.
            description: Optional style description.
            use_as_default: Whether QGIS should use this as the default style.
            geometry_column: Optional geometry column name. Autodetected if omitted.
            geometry_type: Optional geometry type. Autodetected and normalized if omitted.
            owner: Optional metadata field.

        Returns:
            True if the style was inserted successfully.

        Raises:
            FileNotFoundError: If the GeoPackage or QML file does not exist.
            ValueError: If the target layer does not exist in the GeoPackage.
        """
        ...
        with open(qml_path, "r", encoding="utf-8") as file:
            qml_text = file.read()
